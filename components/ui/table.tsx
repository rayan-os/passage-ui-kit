...
>(({ className, ...props }, ref) => (
  <thead 
    ref={ref} 
    className={cn(
      "[&_tr]:border-b [&_tr]:border-glass-border-subtle",
      className
    )} 
    {...props} 
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-glass-border-subtle bg-glass-bg font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      "hover:bg-glass-bg",
      "data-[state=selected]:bg-glass-bg-active",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ...
    className={cn(
      ...
      "[&:has([role=checkbox])]:pr-0 max-w-0 truncate",
      className
    )}
    {...props}
  />
